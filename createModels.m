...
model1 = fitcdiscr(data1,res1,'DiscrimType','quadratic','Cost',tufts.classCost,'Prior','uniform');
model2 = fitcdiscr(data2,res2,'DiscrimType','quadratic','Cost',tufts.classCost,'Prior','uniform');
