function createQuRVAperformance(imPath,trainPath,imFiles,fileTrainingSet,fileModel)

HERE I will create images with small squares that are detected by QuRVA, another that are detected by swiftw but not by qurva,
and anothe with the rest, to see where it fails.

I could even make plots of features to try to understand.
