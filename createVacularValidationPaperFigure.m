...
santiago=load(fullfile(masterFolder, 'ValidationVasculature', 'santiago.mat'));
santiago2=load(fullfile(masterFolder, 'ValidationVasculature', 'santiagoII.mat'));
qurva=load(fullfile(masterFolder, 'ValidationVasculature', 'automatic.mat'));
